<template>
  <section class="">
    ...
    <div>
      ...
      <div v-else class="text-base-content/60 italic">No transactions in this block.</div>
    </div>
  </section>
</template>
...
const hasTxs = computed(() => Array.isArray(blockData.value.txs) && blockData.value.txs.length > 0)
</script>
