  ...
  <div class="space-y-2">
    ...
    >
      ...
      <div class="collapse-title">
        <div
          class="text-base"
          :class="{ 'font-bold': route.params.address === wallet.address }"
        >
          {{ wallet.name }}
        </div>
      </div>
    ...
    >
      ...
      <div class="collapse-content flex flex-col gap-2">
        ...
        <label class="flex items-start gap-2 text-xs"><input
          v-model="seedBackedUp"
          type="checkbox"
          class="checkbox checkbox-xs mt-0.5"
          data-testid="cosmjs-seed-confirm"
        ><span class="opacity-80 text-xs">I have backed up my seed phrase and understand the risks. I take full responsibility
          for my actions.</span></label>
