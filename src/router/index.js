...
const GovernanceProposals = () => import('@/views/chain/GovernanceProposals.vue')
...
const DemoVueQuery = () => import('@/views/DemoVueQuery.vue')
const DemoTanDb = () => import('@/views/DemoTanDb.vue')
...
const routes = [
  ...
  },
  {
    path: '/demo-vue-query',
    name: 'DemoVueQuery',
    component: DemoVueQuery,
  },
  {
    path: '/demo-pina-orm',
    name: 'DemoPiniaOrm',
    component: DemoPiniaOrm,
  },
  {
    path: '/demo/tandb',
    name: 'DemoTanDb',
