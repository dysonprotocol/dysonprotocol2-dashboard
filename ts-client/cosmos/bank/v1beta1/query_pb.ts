 ...
 * Query/DenomMetadata RPC method. Identical with QueryDenomMetadataRequest but
 * receives denom as query string.
 *
...
export const Query: GenService<{
  ...
  /**
   * DenomOwnersByQuery queries for all account addresses that own a particular
   * token denomination.
   *
