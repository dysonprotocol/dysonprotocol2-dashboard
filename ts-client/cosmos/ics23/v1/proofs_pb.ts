...
export type ProofSpec = Message<"cosmos.ics23.v1.ProofSpec"> & {
   ...
   * fixed-depth tries) the max_depth is interpreted as 128 if set to 0
   *
...
export type InnerSpec = Message<"cosmos.ics23.v1.InnerSpec"> & {
  ...
  /**
   * the max prefix length must be less than the minimum prefix length + child
   * size
   *
